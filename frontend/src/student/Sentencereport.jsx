...
// //       doc.setFontSize(20);
// //       doc.text("LexCura ", 105, 14, { align: "center" });
// //       doc.setFontSize(12);
...
//       doc.text("Sentence Fluency — Clinical Progress Report", 105, 22, { align: "center" });
//       doc.setFontSize(9);
...
//         actions.push(["Eye Movement",      "Practise smooth L→R tracking: use a pencil to underline as you read"]);
...
//       {/* ── EYE-TRACKING PANEL ── */}
//       <div style={S.eyePanel}>
//         <div style={S.eyeLeft}>
//           <div style={S.eyeHeader}>
//             <span style={S.eyeIcon}>👁️</span>
//             <div>
//               <h3 style={S.eyeTitle}>Eye-Tracking Analysis</h3>
//               <p style={S.eyeSub}>Visual hesitation during sentence reading</p>
//             </div>
//           </div>
//           {eye.tracked > 0 ? (
//             <div style={S.eyeStats}>
//               <EyeStat label="Sessions tracked"    value={`${eye.tracked}`}       note={`of ${metrics.overview.totalAttempts} total`} />
//               <EyeStat label="Avg hesitation score" value={eye.avgVisualScore}    note={eye.hesitationLevel+" level"} color={hesColor} />
//               <EyeStat label="Hard sessions"        value={`${eye.hardSessions}`} note={`${eye.hardRate}% of total`}
//                 color={parseInt(eye.hardSessions)>0?"#dc2626":"#059669"} />
//             </div>
//           ) : (
//             <div style={S.eyeNoData}>
//               <span style={{ fontSize:28 }}>📷</span>
//               <p style={S.eyeNoDataText}>No eye-tracking data in this period.<br />Enable camera during practice to unlock this analysis.</p>
//             </div>
//           )}
//         </div>

//         {eye.tracked > 0 && (
//           <div style={S.eyeRight}>
...
//       </div>
//       <div style={S.sentMid}>
//         <div style={S.sentId}>Sentence ID: <span style={{ fontFamily:"'Fira Code',monospace", fontWeight:600 }}>{item.sentence}</span></div>
...
//   sentMid:     { flex:1 },
//   sentId:      { fontSize:13,color:"#64748b",marginBottom:8 },
